...
import { Feather, Compass, BookOpen, BookText, FileJson, Wifi, WifiOff, CheckCircle2, Download, MapPin, Layers, Menu } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 bg-slate-900/85 backdrop-blur-xl border-b border-slate-800/80 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Network Status, PWA Install & Hamburger Button */}
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-teal-500/15 hover:bg-teal-500/25 text-teal-300 hover:text-white border border-teal-500/30 transition-all shadow-md flex items-center space-x-1.5"
